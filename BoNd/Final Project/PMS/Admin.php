...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#99CCFF">
	...
	<th width="11%" scope="col"><a href="ADMIN/viewmarks.php">ViewMarks</a></th>
...
<body>
  ...
  <table width="100%" border="0" cellspacing="00" cellpadding="00">
	...
	<th width="11%" scope="col"><a href="FACULTY/allocatemarks.php">allocatemarks</a></th>
...
<body>
  ...
  <tr bgcolor="#99CCFF">
 <th width="7%" scope="col"><h4>&nbsp;</h4></th>
    <th width="13%" scope="col"><a href="STUDENT/searchproject.php">Search Project</a></th>
      <th width="7%" scope="col"><h4>&nbsp;</h4></th>
